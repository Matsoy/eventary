...
VALUES ("Grande vente de fourrure pour reprendre du poil de la bête", 'Ceci est une courte description de ce premier evenement. Voila, rien de plus', datetime('2017-06-19 10:30:00'), datetime('2017-06-20 16:15:00'), 4, 'E168011W', 1, 31);
...
VALUES ("Grand rassemblement pour réconcilier les oeufs brouillés", 'Ceci est une courte description de ce 2nd evenement. Snif', datetime('2017-06-19 11:45:00'), datetime('2017-06-22 16:15:00'), 12, 'E164558G', 6, 82);
...
VALUES ("Grand rassemblement pour dire qu'on est pas content", 'Ceci est une courte description de ce 3eme evenement. Passe ton chemin maintenant', datetime('2017-06-22 22:30:00'), datetime('2017-06-23 03:00:00'), 100, 'E148834B', '19 Rue L�on Blum, 44000 Nantes');
...
VALUES ("Grand débat pour savoir comment est votre blanquette", 'Ceci est une courte description de ce 3eme evenement. Jamais 3 sans 4!', datetime('2017-06-23 21:30:00'), datetime('2017-06-24 00:30:00'), 5, 'E167998G', '4 Rue Lebrun, 44000 Nantes');
